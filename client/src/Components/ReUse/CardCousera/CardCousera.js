    ...
    <>
      <div className=" max-w-[240px] bg-white border border-gray-200 rounded-lg  ">
        <div className=" bg-black ">
          <img className="max-w-full h-auto " src={a.courseImg} alt="" />
        </div>
        ...
        <div className=" pb-5">
          ...
          <div className=" text-gray-400 text-[13px]">{a.teacherName}</div>
          <div className="flex">
            <span className="mr-1 text-yellow-600 font-bold">5.0</span>
